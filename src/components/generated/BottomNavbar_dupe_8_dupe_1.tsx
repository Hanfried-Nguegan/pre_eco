      ...
      <div className="flex-1 p-6 overflow-y-auto pb-32 space-y-6">
        ...
        <div className="pt-4">
           ...
           <div className="flex overflow-x-auto gap-4 pb-4 -mx-6 px-6 scrollbar-hide">
              {[1, 2].map(i => <div key={i} onClick={i === 1 ? onNavigateToDonations : undefined} className={cn("min-w-[280px] h-48 bg-white rounded-[2rem] overflow-hidden relative shadow-sm", i === 1 && "cursor-pointer transition-transform hover:scale-[1.02]")}>
                   ...
                   <div className="absolute top-6 left-0 bg-white py-2 px-6 rounded-r-full shadow-sm">
                      <span className="font-medium text-zinc-800">bring your own</span>
                   </div>
                </div>)}
           </div>
        </div>
