...
export const BottomNavbar = ({
  ...
  return <div className="relative w-full h-full min-h-[600px] bg-zinc-50 flex flex-col font-sans overflow-hidden" data-magicpath-id="0" data-magicpath-path="BottomNavbar.tsx">
      ...
      <div className="flex-1 p-6 overflow-y-auto pb-32 space-y-6" data-magicpath-id="1" data-magicpath-path="BottomNavbar.tsx">
        ...
        <div className="grid grid-cols-2 gap-4" data-magicpath-id="20" data-magicpath-path="BottomNavbar.tsx">
          ...
          <div onClick={onNavigateToSchedule} className="bg-[#E0E0FF] rounded-[2.5rem] p-6 aspect-[4/5] flex flex-col justify-between relative overflow-hidden group cursor-pointer transition-transform hover:scale-[1.02]" data-magicpath-id="21" data-magicpath-path="BottomNavbar.tsx">
             ...
             <div className="absolute bottom-2 right-2 w-32 h-32" data-magicpath-id="25" data-magicpath-path="BottomNavbar.tsx">
                {/* Flower on Scooter Illustration */}
                <svg viewBox="0 0 120 120" className="w-full h-full" data-magicpath-id="26" data-magicpath-path="BottomNavbar.tsx">
                  {/* Scooter - Yellow body */}
                  <ellipse cx="35" cy="75" rx="8" ry="10" fill="#DDF247" data-magicpath-id="27" data-magicpath-path="BottomNavbar.tsx" />
                  <rect x="30" y="65" width="45" height="20" rx="8" fill="#DDF247" data-magicpath-id="28" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="70" cy="75" rx="8" ry="10" fill="#DDF247" data-magicpath-id="29" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Scooter wheels - dark green */}
                  <circle cx="35" cy="85" r="8" fill="#005C4B" data-magicpath-id="30" data-magicpath-path="BottomNavbar.tsx" />
                  <circle cx="70" cy="85" r="8" fill="#005C4B" data-magicpath-id="31" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Scooter handlebar connector */}
                  <rect x="68" y="55" width="4" height="20" fill="#005C4B" rx="2" data-magicpath-id="32" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Character body - green curved */}
                  <path d="M 45 70 Q 40 55 45 40 Q 48 35 52 38 Q 58 48 65 55 Q 68 58 70 62" stroke="#005C4B" strokeWidth="8" fill="none" strokeLinecap="round" data-magicpath-id="33" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Character arms */}
                  <path d="M 48 50 Q 42 48 38 52" stroke="#005C4B" strokeWidth="6" fill="none" strokeLinecap="round" data-magicpath-id="34" data-magicpath-path="BottomNavbar.tsx" />
                  <path d="M 52 45 Q 60 42 68 50 L 72 56" stroke="#005C4B" strokeWidth="6" fill="none" strokeLinecap="round" data-magicpath-id="35" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Hand on handlebar */}
                  <circle cx="72" cy="56" r="4" fill="#005C4B" data-magicpath-id="36" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Flower petals - white */}
                  <ellipse cx="35" cy="25" rx="6" ry="12" fill="white" transform="rotate(-30 45 30)" data-magicpath-id="37" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="40" cy="18" rx="6" ry="12" fill="white" transform="rotate(-10 45 30)" data-magicpath-id="38" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="50" cy="15" rx="6" ry="12" fill="white" transform="rotate(10 45 30)" data-magicpath-id="39" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="58" cy="18" rx="6" ry="12" fill="white" transform="rotate(30 45 30)" data-magicpath-id="40" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="60" cy="25" rx="6" ry="12" fill="white" transform="rotate(50 45 30)" data-magicpath-id="41" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="58" cy="35" rx="6" ry="12" fill="white" transform="rotate(70 45 30)" data-magicpath-id="42" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="50" cy="40" rx="6" ry="12" fill="white" transform="rotate(90 45 30)" data-magicpath-id="43" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="40" cy="38" rx="6" ry="12" fill="white" transform="rotate(110 45 30)" data-magicpath-id="44" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Flower center - yellow */}
                  <circle cx="47" cy="28" r="10" fill="#FFD700" data-magicpath-id="45" data-magicpath-path="BottomNavbar.tsx" />
                  
                  {/* Sunglasses */}
                  <ellipse cx="44" cy="27" rx="3" ry="2.5" fill="#1a1a3a" data-magicpath-id="46" data-magicpath-path="BottomNavbar.tsx" />
                  <ellipse cx="50" cy="27" rx="3" ry="2.5" fill="#1a1a3a" data-magicpath-id="47" data-magicpath-path="BottomNavbar.tsx" />
                  <line x1="47" y1="27" x2="47" y2="27" stroke="#1a1a3a" strokeWidth="1.5" />
                  
                  {/* Happy smile */}
                  <path d="M 44 31 Q 47 33 50 31" stroke="#1a1a3a" strokeWidth="1.5" fill="none" strokeLinecap="round" data-magicpath-id="48" data-magicpath-path="BottomNavbar.tsx" />
                </svg>
             </div>
          </div>

          <div className="flex flex-col gap-4" data-magicpath-id="49" data-magicpath-path="BottomNavbar.tsx">
            {/* Points Card */}
            <div className="bg-[#DDF247] rounded-[2.5rem] p-6 flex items-center justify-center relative" data-magicpath-id="50" data-magicpath-path="BottomNavbar.tsx">
               <div className="text-center" data-magicpath-id="51" data-magicpath-path="BottomNavbar.tsx">
                  <span className="text-2xl font-bold text-[#2A1805]" data-magicpath-id="52" data-magicpath-path="BottomNavbar.tsx">216</span>
                  <span className="text-sm font-medium text-[#2A1805] ml-1" data-magicpath-id="53" data-magicpath-path="BottomNavbar.tsx">points</span>
               </div>
               {/* Connector visual trick */}
               <div className="absolute -top-4 right-8 w-8 h-8 bg-[#DDF247] rounded-full" data-magicpath-id="54" data-magicpath-path="BottomNavbar.tsx" /> 
            </div>

            {/* Sorting Guide Card */}
            <div className="bg-[#005C4B] rounded-[2.5rem] p-6 flex-1 flex flex-col justify-end relative overflow-hidden group cursor-pointer transition-transform hover:scale-[1.02]" data-magicpath-id="55" data-magicpath-path="BottomNavbar.tsx">
               <div className="absolute top-4 right-4 opacity-10" data-magicpath-id="56" data-magicpath-path="BottomNavbar.tsx">
                  <div className="w-16 h-16 bg-white rotate-45 transform" data-magicpath-id="57" data-magicpath-path="BottomNavbar.tsx"></div>
               </div>
               <h3 className="text-white font-medium leading-tight mt-8" data-magicpath-id="58" data-magicpath-path="BottomNavbar.tsx">Sorting<br data-magicpath-id="59" data-magicpath-path="BottomNavbar.tsx" />guide</h3>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4" data-magicpath-id="60" data-magicpath-path="BottomNavbar.tsx">
           ...
           <div className="flex overflow-x-auto gap-4 pb-4 -mx-6 px-6 scrollbar-hide" data-magicpath-id="62" data-magicpath-path="BottomNavbar.tsx">
              {[1, 2].map(i => <div key={i} className="min-w-[280px] h-48 bg-white rounded-[2rem] overflow-hidden relative shadow-sm" data-magicpath-id="63" data-magicpath-path="BottomNavbar.tsx">
                   ...
                   <div className="absolute top-6 left-0 bg-white py-2 px-6 rounded-r-full shadow-sm" data-magicpath-id="66" data-magicpath-path="BottomNavbar.tsx">
                      <span className="font-medium text-zinc-800" data-magicpath-id="67" data-magicpath-path="BottomNavbar.tsx">Become a volunteer</span>
                   </div>
                </div>)}
           </div>
        </div>
      ...
      <div className="absolute bottom-8 left-0 right-0 px-6 z-50 flex justify-center pointer-events-none" data-magicpath-id="68" data-magicpath-path="BottomNavbar.tsx">
        <nav className="bg-white p-2.5 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex items-center gap-2 pointer-events-auto max-w-md w-full justify-between" data-magicpath-id="69" data-magicpath-path="BottomNavbar.tsx">
          ...
          return <motion.button key={item.id} onClick={() => setActiveTab(item.id)} className={cn("relative flex items-center justify-center rounded-[2rem] transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] cursor-pointer -webkit-tap-highlight-color-transparent outline-none", isActive ? "flex-grow px-6 py-3 bg-[#2A1805]" : "w-12 h-12 hover:bg-zinc-100")} layout transition={{
            ...
            stiffness: 500,
            damping: 35
          }} data-magicpath-id="70" data-magicpath-path="BottomNavbar.tsx">
                {/* Active State Content */}
                <AnimatePresence mode="wait" data-magicpath-id="71" data-magicpath-path="BottomNavbar.tsx">
                ...
                duration: 0.3,
                delay: 0.1
              }} data-magicpath-id="72" data-magicpath-path="BottomNavbar.tsx">
                      <item.icon size={20} className="text-white shrink-0" strokeWidth={2.5} data-magicpath-id="73" data-magicpath-path="BottomNavbar.tsx" />
                  ...
                  delay: 0.15
                }} data-magicpath-id="74" data-magicpath-path="BottomNavbar.tsx">
                        {item.label}
                      </motion.span>
                    </motion.div>}
                </AnimatePresence>
              ...
              duration: 0.2
                    ...
                    <item.icon size={24} className="text-zinc-400" strokeWidth={2} data-magicpath-id="76" data-magicpath-path="BottomNavbar.tsx" />
                  </motion.div>}
              </motion.button>;
        })}
        </nav>
