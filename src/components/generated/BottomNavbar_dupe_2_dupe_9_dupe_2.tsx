  ...
  return <div className="relative w-full h-full min-h-[600px] bg-zinc-50 flex flex-col font-sans overflow-hidden">
      ...
      <div className="flex-1 p-6 overflow-y-auto pb-32 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {/* Courier Card */}
          <div className="bg-[#E0E0FF] rounded-[2.5rem] p-6 aspect-[4/5] flex flex-col justify-between relative overflow-hidden group cursor-pointer transition-transform hover:scale-[1.02]">
             <div className="relative z-10">
